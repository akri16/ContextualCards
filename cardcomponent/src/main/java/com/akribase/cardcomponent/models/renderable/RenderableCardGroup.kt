...
import com.akribase.cardcomponent.utils.checkEqual
    ...
    companion object {
        ...
        val DIFFCALLBACK = object : DiffUtil.ItemCallback<RenderableCardGroup>() {
            ...
            override fun areContentsTheSame(
                oldItem: RenderableCardGroup,
                newItem: RenderableCardGroup
            ) = checkEqual(oldItem, newItem, { isScrollable }, { cards.size }, { designType })
        }
        ...
        fun createFromCardGroup(cardGroup: CardGroup): RenderableCardGroup {
            ...
            return with(cardGroup) {
                val isScrollable = if (designType in arrayOf(
                        DesignType.HC9,
                        DesignType.HC3
                    )
                ) true else isScrollable
